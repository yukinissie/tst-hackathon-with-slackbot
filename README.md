...
# はじめに
## 所要時間
- 2~4時間（メンバーさんに協力してもらい検証しました）
- 制作者想定1時間でしたが冷静に考えると無理でした。。

## 対応プラットフォーム（ざっくり）
- Windows 10（おそらく11も可）[Win]
- MacOSX [Mac]
...
- おまけ：[Python版SlackBot用プログラム](https://github.com/yukinissie/slackbot-template-with-python)(Herokuデプロイ対応。venv対応。もちろんdotenv対応)
